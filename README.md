...
7. **[Document Extraction & Parsing](https://docs.maxun.dev/)** – Extract structured data from documents and images (PDF, JPG, PNG) with OCR, or convert them into clean Markdown, HTML, or a list of links.
...
Upload a document or image — PDF, JPG, or PNG — and Maxun reads the text out of it using OCR. Convert it into clean Markdown, HTML, or a list of links, or use AI-powered extraction to pull specific structured fields.
...
- ✨ **Extract From Documents & Images** – OCR PDFs, JPG, and PNG into structured data, Markdown, HTML, or links
