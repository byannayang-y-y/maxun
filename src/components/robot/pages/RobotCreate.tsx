...
const RobotCreate: React.FC = () => {
  ...
  const handleCreateDocumentRobot = async () => {
    if (!documentFile) { notify('error', 'Please upload a PDF, JPG, or PNG file'); return; }
        ...
        <TabPanel value={tabValue} index={4}>
          <Card sx={{ mb: 4, p: 4 }}>
            <Box display="flex" flexDirection="column" alignItems="center">
              ...
              />
              <Typography variant="body2" color="text.secondary" mb={3}>
                Process PDFs, JPGs, or PNGs with AI — extract structured fields or convert to Markdown, HTML, and links.
              </Typography>
              ...
              <Box sx={{ width: '100%', maxWidth: 700 }}>
                ...
                >
                  ...
                  {documentFile ? (
                    ...
                    <>
                      <Typography variant="body1" fontWeight={500}>Click to upload a PDF, JPG, or PNG file</Typography>
